...
PATH_TO_CKPT = '/Users/pragneshbagary/Downloads/majorproject/Mirror/backend/backend/hand_inference_graph/frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(MODEL_NAME, 'hand_label_map.pbtxt')

NUM_CLASSES = 1
# load label map
label_map = label_map_util.load_labelmap('/Users/pragneshbagary/Downloads/majorproject/Mirror/backend/backend/hand_inference_graph/hand_label_map.pbtxt')
