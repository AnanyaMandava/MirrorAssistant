...
class Video(object):
    ...
    def run(self):
        ...
        detection_model_path = '/Users/pragneshbagary/Downloads/majorproject/Mirror/backend/backend/haarcascade_frontalface_default.xml'
        emotion_model_path = '/Users/pragneshbagary/Downloads/majorproject/Mirror/backend/backend/fer2013_mini_XCEPTION.102-0.66.hdf5'
        ...
        while True:
            ...
            print(self.total_displacement/(self.num_frames), self.current_emotion, self.emotions)
